...
def evaluate(model, data_loader, fabric):
    ...
    fabric.print("CEL Computing features for evaluation...")
        ...
        fabric.log_dict(
            {
                ...
                "val/R50": eval_result["R50"],
                "val/MnR": eval_result["MnR"],
                "val/MdR": eval_result["MdR"],
                "val/meanR3": eval_result["meanR3"],
                "val/meanR4": eval_result["meanR4"],
            }
        )
